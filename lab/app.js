...
function sumAndMultiply(a,b,c){ //eslint-disable-line
  ...
  var $multi3 = multiply(multiply(a, b)[0], c)[0];
  var $msg = a + ' and ' + b + ' and ' + c + ' sum to ' + $sum3 + '.';
  var $msg2 = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + $multi3 + '.';
  console.log($msg, $msg2);
  return [$sum3, $multi3, $msg, $msg2];
}
...
function sumArray(testArray){ //eslint-disable-line
  var arraySum = testArray.length;
  var total = 0;
  var msg;

  for( var i = 0; i < arraySum; i++){
    total = sum(total, testArray[i])[0];
    console.log(total);
  //end of for loop
  }

  msg = '2,3,4 was passed in as an array of numbers, and ' + total + ' is their sum.';
  console.log(msg);
  return [total, msg];
//end of function
}
...
// Write your code here
// testArray = [2,3,4] and is on line 100;
function multiplyArray(testArray){ //eslint-disable-line
  var arrayProduct = testArray.length;
  var total = 1;
  var msg;

  for( var i = 0; i < arrayProduct; i++){
